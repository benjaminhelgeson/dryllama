...
import myData from '../../data/parks/little_big_horn.json';
...
export default function LittleBigHornScreen() {
	return (
	  <div className="px-10 mt-2 bg-black text-white">
	    ...
	    <SubtitleDisplay
	      title="Little Big Horn National Monument"
	    ></SubtitleDisplay>
	    ...
	    >
			{_.map(myData?.little_big_horn, data => {
				return(
					<ImageDisplay
			    		href={data[0].href}
			    		src={data[0].src}
