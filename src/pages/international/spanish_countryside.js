...
import myData from '../../data/international/spanish_countryside.json';
...
export default function SpanishCountrysideScreen() {
	return (
	  <div className="px-10 mt-2 bg-black text-white">
	    ...
	    >
			{_.map(myData?.spanish_countryside, data => {
				return(
					<ImageDisplay
			    		href={data[0].href}
			    		src={data[0].src}
