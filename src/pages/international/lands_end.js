...
import myData from "../../data/international/lands_end.json";
...
export default function LandsEndScreen() {
  return (
    <div className="px-10 mt-2 bg-black text-white">
      <TitleDisplay goTo="/" title="Dry Llama"></TitleDisplay>

      <SubtitleDisplay title="Land's End, England"></SubtitleDisplay>
