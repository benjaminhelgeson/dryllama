...
import myData from "../../data/usa/san_diego.json";
...
export default function SanDiegoScreen() {
  return (
    <div className="px-10 mt-2 bg-black text-white">
      <TitleDisplay goTo="/" title="Dry Llama"></TitleDisplay>

      <SubtitleDisplay title="San Diego, California"></SubtitleDisplay>
