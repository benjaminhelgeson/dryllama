...
import myData from '../../data/usa/golden_gate_canyon.json';
...
export default function GoldenGateCanyonScreen() {
	return (
	  <div className="px-10 mt-2 bg-black text-white">
	    ...
	    <SubtitleDisplay
	      title="Golden Gate Canyon, Colorado"
	    ></SubtitleDisplay>
	    ...
	    >
			{_.map(myData?.golden_gate_canyon, data => {
				return(
					<ImageDisplay
			    		href={data[0].href}
			    		src={data[0].src}
